...
| `panel-skill-management.png` | 「技能管理-已安装技能」页 | 2026-06-26 |  |
| `panel-skill-management-2.png` | 「技能管理-外部技能市场」页 | 2026-06-26 |  |
| `panel-monitor.png` | 监控任务面板 | 2026-06-26 |  |
| `context window.png` | 上下文预算窗口 | 2026-06-26 |  |
| `channel management.png` | 「频道管理」页 | 2026-06-26 |  |
| `add_new_workspace.png` | 「新建工作区」页 | 2026-06-26 |  |
| `save_as_self-defined_template.png` | 将工作区导出为自定义模板 | 2026-06-26 |  |
| `demo-identity-image.png` |图像识别结果 | 2026-06-26 |  |
| `demo-identity-image.png` |图表识别过程和产物 | 2026-06-26 |  |
