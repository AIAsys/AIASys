...
`aiasys/python-data-analysis:1.0.0`。
...
docker build -t aiasys/python-data-analysis:1.0.0 .
docker save aiasys/python-data-analysis:1.0.0 -o .docker-images/python_data_analysis.tar
```

## 产物位置

- Docker 镜像：`aiasys/python-data-analysis:1.0.0`
