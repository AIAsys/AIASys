...
interface UseWorkspaceLifecycleActionsParams {
  ...
  executor: AnalysisWorkspaceLayoutProps["executor"];
  leaveProjectWorkspace: () => void;
  loadWorkspaces: AnalysisWorkspaceLayoutProps["loadWorkspaces"];
  navigateToWorkspaceConversation: (
    workspaceId: string,
    sessionId: string,
  ) => void;
  onDeleteSession: AnalysisWorkspaceLayoutProps["onDeleteSession"];
