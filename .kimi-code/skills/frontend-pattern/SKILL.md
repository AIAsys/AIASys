...
description: Develop React 19 frontend following AIASys design system and best practices. Use when creating React components, implementing pages, handling state management, or dealing with async operations and race conditions. This skill covers React 19 patterns, Tailwind CSS 4 usage, shadcn/ui integration, and concurrency protection. Always use this skill when the user asks you to create a component, build a page, implement UI features, or work with React in the AIASys project.
---
