...
**Don'ts:**
- Bad: Outline in nav + solid in buttons + duotone in cards
- Bad: Mixing libraries (Lucide + Heroicons = collage)
- Bad: Custom icons that ignore the system's grid/stroke
