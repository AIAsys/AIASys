---
name: state-flow
description: Design and implement state flows for complex UI interactions and system processes. Use when designing multi-step workflows, handling complex state transitions, implementing state machines, or documenting user interaction flows. This skill provides patterns for state flow diagrams, state machines, and interaction specifications. Always use this skill when the user asks you to design a workflow, create a state diagram, or implement complex state management.
---
