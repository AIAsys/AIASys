...
### Rule 5: Visually Verify Every Section
...
### Rule 6: Reuse Existing Assets (Logos, Icons, Images)
...
### Rule 7: Always Load the `frontend-design` Skill
...
5. pencil_get_guidelines          -> Get relevant design rules
6. pencil_get_style_guide_tags    -> (optional) Get style inspiration
7. pencil_get_style_guide         -> (optional) Apply style direction
8. pencil_find_empty_space_on_canvas -> Find space for new screen
9. pencil_batch_design            -> Build the design (section by section)
